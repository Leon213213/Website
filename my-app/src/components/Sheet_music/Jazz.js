            ...
            <div className='container-side-by-side'>
              <div className="container-on-top">
                ...
                <NestedAccordion title="C" isOpen={allOpen}>
                  ...
                  <Accordion title="Colonial Rag">
                    <a target="_blank" href="https://drive.google.com/file/d/1-J4mptWrxAt7Umq5cq8UzcV4vQpLhzHG/view?usp=sharing">Colonial Rag - J.Lenzberg and E.Ball.pdf</a>
                  </Accordion>
                  <Accordion title="Charm">
                    <a target="_blank" href="https://drive.google.com/file/d/1HZQZ8tM35khvUyhvHgUdKX3nzzjnjwfi/view?usp=sharing">Charm - Vesnyak.pdf</a>
                  </Accordion>

                </NestedAccordion>
                <NestedAccordion title="D" isOpen={allOpen}>
                  <Accordion title="Dream A Little Dream of Me">
                    <a target="_blank" href="https://drive.google.com/file/d/1p2g1hmNdVp7TwcmEeKzrqgpJuTa4ctD7/view?usp=sharing">Dream A Little Dream of Me - Fabian Andre.pdf</a>
                  </Accordion>
                </NestedAccordion>
                <NestedAccordion title="E" isOpen={allOpen}>
                  <Accordion title="Entertainer">
                    <a target="_blank" href="https://drive.google.com/file/d/1BrIJIhJNU6oFfjEbL2qmQrTo7ifo__R-/view?usp=sharing">Entertainer - Scott Joplin.pdf</a>
                  </Accordion>
                </NestedAccordion>
                ...
                <NestedAccordion title="I" isOpen={allOpen}>
                  <Accordion title="It's Beginning to Look a Lot Like Christmas">
                    <a target="_blank" href="https://drive.google.com/file/d/1VBsTqqFUGqH0poLz-OuF6D8yqWlA1MLz/view?usp=sharing">It's Beginning to Look a Lot Like Christmas.pdf</a>
                  </Accordion>
                </NestedAccordion>
                ...
                <NestedAccordion title="L" isOpen={allOpen}>
                  <Accordion title="Let It Snow">
                    <a target="_blank" href="https://drive.google.com/file/d/1IAGu05DtXdi-uAqQAUlZLvSpEDvz1Vn_/view?usp=sharing">Let It Snow.pdf</a>
                  </Accordion>
                </NestedAccordion>
                <NestedAccordion title="M" isOpen={allOpen}>
                  <Accordion title="Misty">
                    <a target="_blank" href="https://drive.google.com/file/d/1y8DBjGZr-Xq-BuaiwiFma9Ko3N7MgyO_/view?usp=sharing">Misty - Erroll Garner.pdf</a>
                  </Accordion>
                  <Accordion title="Maple Leaf Rag">
                    <a target="_blank" href="https://drive.google.com/file/d/1M-QnauRS4TbZvb511rRxcuU_69nRQFxO/view?usp=sharing">Maple Leaf Rag - Scott Joplin.pdf</a>
                  </Accordion>
                </NestedAccordion>
              </div>
              <div className="container-on-top">
                ...
                <NestedAccordion title="O" isOpen={allOpen}>
                  <Accordion title="Over the Rainbow">
                    <a target="_blank" href="https://drive.google.com/file/d/1DBpr2gexhkAnPDCIvToqYIfPxu_bQknO/view?usp=sharing">Over the Rainbow - Harold Arlen.pdf</a>
                  </Accordion>
                </NestedAccordion>
